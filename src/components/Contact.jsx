    ...
    <section id="contact" className="bg-[#FFF5E8] py-24">
      <div className="mx-auto max-w-3xl px-6 text-center">
        <motion.h2
          ...
          className="text-3xl font-semibold tracking-tight text-[#002B47]"
        >
          Let’s Work Together
        </motion.h2>
        <motion.p
          ...
          className="mx-auto mt-3 max-w-2xl text-[#5F6C7B]"
        >
        ...
        <div className="mt-8 flex items-center justify-center gap-4">
          ...
          <a href="https://www.linkedin.com/in/rami-najem/" target="_blank" rel="noreferrer" aria-label="LinkedIn" className="flex h-10 w-10 items-center justify-center rounded-full border border-[#002B47]/15 text-[#002B47] hover:bg-white">
        ...
        <motion.form
          ...
          className="mx-auto mt-12 grid max-w-xl grid-cols-1 gap-4 text-left"
        >
